...
export const criarAudicao = async (req, res) => {
  try {
...
export const listarAudicoes = async (req, res) => {
  try {
...
export const atualizarAudicao = async (req, res) => {
  try {
    const { titulo, descricao, dataAudicao, qtdPapeis } = req.body;
...
export const deletarAudicao = async (req, res) => {
  try {
