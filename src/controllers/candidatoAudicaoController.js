...
export default class CandidatoAudicaoController {
  static criarCandidato = async (req, res) => {
    try {
      const {
        usuarioId,
        audicaoId,
  ...
  static listarCandidatos = async (req, res) => {
    try {
  ...
  static atualizarCandidato = async (req, res) => {
    try {
      const {
        usuarioId,
        audicaoId,
  ...
  static deletarCandidato = async (req, res) => {
    try {
